          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            <div className="grid items-center gap-14 lg:grid-cols-[0.9fr_1.1fr]">
              <div>
                ...
                >
                  Pixie Dust Labs needed a modern website that clearly explained their pharmaceutical claims validation software while making the company feel credible, professional, and enterprise-ready.
                </motion.p>
                <motion.div whileHover={{ y: -6, scale: 1.02 }} className="mt-8 rounded-[1.8rem] border border-white/10 bg-white/5 p-7 shadow-[0_0_60px_rgba(139,92,246,0.15)] backdrop-blur-2xl transition hover:border-violet-300/40 hover:shadow-[0_0_85px_rgba(139,92,246,0.28)]">
                  ...
                  <div className="mt-5 flex items-center gap-4">
                    ...
                    <p className="font-black text-white">Doug B., Founder</p>
                  </div>
                </motion.div>
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
